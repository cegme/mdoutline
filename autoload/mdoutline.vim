...
function! s:has_main_buffers()
  echom "MDOutline: Checking for main buffers..."
...
function! s:get_help_line_count()
  return len(s:get_help_text())
    ...
    echom "MDOutline: Buffer " . bufnr . " (" . bufname(bufnr) . ") - buftype: " . buftype . ", filetype: " . filetype
    ...
    " Found a main buffer
    echom "MDOutline: Found main buffer: " . bufnr
    return 1
  endfor
  
  " No main buffers found
  echom "MDOutline: No main buffers found."
  return 0
endfunction
